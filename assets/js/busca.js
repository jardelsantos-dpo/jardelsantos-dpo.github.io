(() => {
    ...
    const pages = [
		...
		{ url: "artigos/plano-continuidade-negocios-sempre-atualizado.html", name: "Por que precisamos de um plano de contingência para o plano de contingência? Uma forma segura de ter um Plano de Continuidade de Negócios sempre ativo e atualizado",   keywords: "plano de continuidade de negócios, PCN, BCP, ISO 22301, gestão de riscos, disaster recovery, DRP, LGPD, ANPD, incidente de segurança, BIA, RTO, RPO, resiliência organizacional, plano de contingência, backup, segurança da informação, compliance, governança de TI, teste de continuidade, ransomware, comunicação de incidente, encarregado de dados, Resolução ANPD 15/2024" },
		{ url: "artigos/skills-claude-plano-free-pequenas-empresas.html", name: "Skills do Claude no Plano Free: Como Pequenas Empresas Podem Automatizar Decisões", Keywords: "skills claude, plano free, automação, lgpd, privacidade, dashboard, kpi, pequenas empresas, segurança da informação, power automate, n8n" },
